...
<fieldset id="fieldset-reference-list"><legend><?php echo __('Subject Index'); ?></legend>
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('reference_list_enabled',
                __('Enable list view')); ?>
        </div>
        <div class="inputs five columns omega">
            <?php echo $this->formCheckbox('reference_list_enabled', true,
                array('checked' => (boolean) get_option('reference_list_enabled'))); ?>
            <p class="explanation">
                <?php echo __('Enable the page and display the link "%s" to the list view in the navigation bar.',
                    '<a href="' . url(ReferencePlugin::REFERENCE_PATH_LIST) . '">' . url(ReferencePlugin::REFERENCE_PATH_LIST). '</a>'); ?>
            </p>
        </div>
    </div>
    <div class="field">
